...
# Mastering Backend - E-Learning API: Build Your Own Coursera

![Design preview for the E-Learning API: Build Your Own Coursera](https://pub-63da695b9ece47c5b3b49bd78b86d884.r2.dev/Build%20Your%20Own%20Library%20Management%20System.png)
...
The project is to build **E-Learning API: Build Your Own Coursera** and get the front end working (the front end has already integrated the API).

[Click here to view more details about this project.](https://app.masteringbackend.com/projects/e-learning-api:-build-your-own-coursera)
...
- Enable users to browse, search, and filter courses.
...
Your task is to Build Your Own Coursera. You will find an SQLite database file called `db.sqlite` inside the root folder. You will find the front end of each project on the project description page. 
